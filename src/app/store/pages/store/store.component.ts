...
import { faBasketShopping, faBreadSlice, faCreditCard, faDrumstickBite, faJar, faTruckArrowRight, faTruckFast, faWarehouse } from '@fortawesome/free-solid-svg-icons';
  ...
  topCategories = [
    {
      ...
      label: 'Carnicos',
      image: 'https://static.wixstatic.com/media/61995d_543483b18d384e168dfa1b4e84978162~mv2.jpg/v1/fill/w_500,h_332,al_c,q_80,enc_auto/61995d_543483b18d384e168dfa1b4e84978162~mv2.jpg'
    },
    {
      icon: faBreadSlice,
      label: 'Panificación',
      image: 'https://static.wixstatic.com/media/a12e70_30ff5e87eceb4eb49bd6a58b93a01d67~mv2.jpg/v1/fill/w_3600,h_2400,al_c,q_90/Bandejas%20pan%20Hamburguesa%3B%20Perro.JPG'
    },
    {
      icon: faJar,
      label: 'Salsas Y Aderezos',
      image: 'https://distribuidoradumy.com/wp-content/uploads/2021/08/Portada-para-salsas.jpg'
    },
    {
      icon: faJar,
      label: 'Sazonadores',
      image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRN0G4Uvr9bLVqCP8mUl8-7fcKPmCNDvU0uDQ&s'
    }
  ]
